...
def draw(c):
    ...
    if ( ball_velocity[0]>0 and ball_position[0]> WIDTH/2 and ball_position[1]>paddle2_position+PAD_HEIGHT/2):
        paddle2_vel=4
    elif ( ball_velocity[0]>0 and ball_position[0]> WIDTH/2 and ball_position[1]<paddle2_position+PAD_HEIGHT/2 and ball_position[1]>paddle2_position-PAD_HEIGHT/2 ):
        paddle2_vel=0
    elif ( ball_velocity[0]>0 and ball_position[0]> WIDTH/2 and ball_position[1]<paddle2_position-PAD_HEIGHT/2):
        paddle2_vel=-4
